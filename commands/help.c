...
void analize_help() {
    ...
    print_arg(SESSION_HDR_ARG, SESSION_HDR_ARG_DESC, DEFAULT_SPACE, DEFAULT_PIPE, NULL);
    print_arg(PRESENTATION_HDR_ARG, PRESENTATION_HDR_ARG_DESC, DEFAULT_SPACE, DEFAULT_PIPE, NULL);
